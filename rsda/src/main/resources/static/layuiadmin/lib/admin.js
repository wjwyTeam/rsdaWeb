   ...
   F = P.events = {
    ...
    note: function (e) {
     ...
     F.note.index = P.popup({
      title: "便签",
      shade: 0.5,
      offset: ["82%", a ? null : e.offset().left - 15 + "px"],
      anim: -1,
      id: "LAY_adminNote",
